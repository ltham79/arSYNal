...
function RunAsKeyReceiver()
{
    ...
    do
        ...
        then
            ...
            elif [[ $key == "A" || $key == "w" ]]; then sig=$sigRotate
            elif [[ $key == "B" || $key == "s" ]]; then sig=$sigDown
            elif [[ $key == "D" || $key == "a" ]]; then sig=$sigLeft
            elif [[ $key == "C" || $key == "d" ]]; then sig=$sigRight
...
function InitDraw()
{
    ...
    echo -ne "\033[1m                                                 Modified By Psiber_Syn 2024"
...
function ShowExit()
{
    ...
    echo -e "\033[${y};0HGameOver!!!! Please Try Again!!!! \033[0m"
    exit
}
...
function Usage
{
        cat << EOF
Usage: $APP_NAME
Start tetris game. (linuxscriptshub.com)-Modified By Psiber_Syn
